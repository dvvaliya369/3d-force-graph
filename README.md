...
* [Node search & highlight](https://vasturiano.github.io/3d-force-graph/example/node-search/) ([source](https://github.com/vasturiano/3d-force-graph/blob/master/example/node-search/index.html))
